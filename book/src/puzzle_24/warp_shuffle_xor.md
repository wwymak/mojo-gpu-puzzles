...
```mojo
{{#include ../../../solutions/p24/p24.mojo:butterfly_pair_swap_solution}}
```
...
```mojo
{{#include ../../../solutions/p24/p24.mojo:butterfly_parallel_max_solution}}
```
...
```mojo
{{#include ../../../solutions/p24/p24.mojo:butterfly_conditional_max_solution}}
```
